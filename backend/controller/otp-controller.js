...
export const sendEmail = async (request, response) => {
    try {
        ...
        if (useCase === "register") {
            subjectMessage = "OTP for Registering - FinLock!"
            htmlTemplate = `
            <div style="font-family: Helvetica,Arial,sans-serif;min-width:1000px;overflow:auto;line-height:2">
                <div style="margin:50px auto;width:70%;padding:20px 0">
                    <div style="border-bottom:1px solid #eee">
                        <a href="" style="font-size:1.4em;color: #00466a;text-decoration:none;font-weight:600">FinLock</a>
                    </div>
                    <p style="font-size:1.1em">Hi ${name},</p>
                    <p>Thank you for registering for FinLock. Use the following OTP to complete your Registration procedure. OTP is valid for 5 minutes</p>
                    <h2 style="background: #00466a;margin: 0 auto;width: max-content;padding: 0 10px;color: #fff;border-radius: 4px;">${otp}</h2>
                    <p style="font-size:0.9em;">Regards,<br />FInLock</p>
                    <hr style="border:none;border-top:1px solid #eee" />
                </div>
            </div>
            `
        } else if (useCase === "login") {
            subjectMessage = "OTP for Login - FinLock!"
            htmlTemplate = `
            <div style="font-family: Helvetica,Arial,sans-serif;min-width:1000px;overflow:auto;line-height:2">
                <div style="margin:50px auto;width:70%;padding:20px 0">
                    <div style="border-bottom:1px solid #eee">
                    ...
                    <p style="font-size:1.1em">Hi ${name},</p>
                    <p>Thank you for choosing FinLock. Use the following OTP to complete your Login procedure. OTP is valid for 5 minutes</p>
                    <h2 style="background: #00466a;margin: 0 auto;width: max-content;padding: 0 10px;color: #fff;border-radius: 4px;">${otp}</h2>
                    <p style="font-size:0.9em;">Regards,<br />FinLock</p>
                    <hr style="border:none;border-top:1px solid #eee" />
                </div>
            ...
            subjectMessage = "OTP for Reseting Password - FinLck!"
            htmlTemplate = `
            <div style="font-family: Helvetica,Arial,sans-serif;min-width:1000px;overflow:auto;line-height:2">
                <div style="margin:50px auto;width:70%;padding:20px 0">
                    <div style="border-bottom:1px solid #eee">
                    ...
                    <p style="font-size:1.1em">Hi ${name},</p>
                    <p>Thank you for choosing FinLock. Use the following OTP to reset your password. OTP is valid for 5 minutes</p>
                    <h2 style="background: #00466a;margin: 0 auto;width: max-content;padding: 0 10px;color: #fff;border-radius: 4px;">${otp}</h2>
                    <p style="font-size:0.9em;">Regards,<br />FinLock</p>
                    <hr style="border:none;border-top:1px solid #eee" />
                </div>
            ...
            subjectMessage = "Account Blocked! - FinLock"
            htmlTemplate = `
            <div style="font-family: Helvetica,Arial,sans-serif;min-width:1000px;overflow:auto;line-height:2">
                <div style="margin:50px auto;width:70%;padding:20px 0">
                    <div style="border-bottom:1px solid #eee">
